...
V2RAY_DIR=v2ray
V2RAY_HOME=${DEPLOY_ROOT}/${V2RAY_DIR}
...
deploy_v2ray()
{
    ...
    then
        echoY "Already deployed v2ray in ${V2RAY_HOME}, check it there first!"
        exit 1
    else
        echoY "Deploying v2ray..."
        cp -a ./src ${V2RAY_HOME}
        echoG "v2ray has been deployed to ${V2RAY_HOME} successfully."
        cat ./src/README.md
    fi
}
